...
class _PaymentState extends State<Payment> {
  Token? _paymentToken;
   ...
   String? _error;
  final String _currentSecret = "sk_test_51L57pHFdu1FcbionmckYzBUoFAhHOCebYLtLjnC9Use0Kx2Lt9o7oh2Ebg88lCI8kbdwGnWmdxvFYnX0CiHd8i0u004xe2gxed"; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(
        StripeOptions(publishableKey: "pk_test_51L57pHFdu1FcbionD5KZDn5s4EpXEPrwJ6ZZb7LbVGmOIxLraKJcbXvMoO0s0fADQLoGYdqz5Xzy1D5Yhtm5l9PB00XItdsWSW",
            merchantId: "test",
            androidPayMode: 'test'));
  }
